...
lang: en
ref: what-is-carry
title: "Understanding Carry in Arithmetic"
date: 2025-09-16 11:45:00 +0900
...
***Carry in*** is the carry value passed from a lower bit operation, and ***Carry out*** is the carry value resulting from the current bit operation. This process is typically handled by a hardware [Full Adder](https://en.wikipedia.org/wiki/Adder_(electronics)#Full_adder) circuit.

*Carry in* ensures continuity and accuracy in multi-bit operations.

**Example**: Adding `13` and `7` in a `4-bit` space
{% highlight text mark_lines="1 6" %}
carry in   :  1   1   1   1   0
13 (1101)  :      1   1   0   1
7  (0111)  :      0   1   1   1
--------------------------------
